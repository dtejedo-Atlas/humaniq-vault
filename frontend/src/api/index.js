...
export const taxonomyAPI = {
  ...
  getHumaniqCatalog: () => axios.get(`${API_BASE}/taxonomy/humaniq`),
...
export const usersAPI = {
  ...
  resendInvitation: (id, origin) => axios.post(`${API_BASE}/users/${id}/resend-invitation`, { origin }),
  sendPasswordReset: (id, origin) => axios.post(`${API_BASE}/users/${id}/send-password-reset`, { origin }),
